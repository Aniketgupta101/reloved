...
| `08-admin-claim-chat-reply.png` | **Admin — Message user on in-process claim** — API-verified thread claim_T8xnWHUunP50SDpSzD9f (2 msgs) — open Message user on UAT card |
