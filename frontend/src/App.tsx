        ...
        <Route element={<PublicLayout />}>
          ...
          <Route path="*" element={
            <div className="text-center py-32 flex flex-col items-center justify-center gap-4">
              ...
              <a href="/" onClick={() => track(AnalyticsEvent.navLink, { label: "Return Home", path: "/", source: "404" })} className="px-6 py-3 bg-accent-pink border-2 border-foreground font-black uppercase text-sm shadow-[4px_4px_0px_rgba(0,0,0,1)]">Return Home</a>
            </div>
          } />
        </Route>
