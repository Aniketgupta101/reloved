  ...
  return (
    <div className="w-full max-w-md mx-auto px-4 py-24 flex flex-col gap-8">
      ...
      <form onSubmit={handleSubmit} className="bg-white border-2 border-foreground p-8 shadow-[8px_8px_0px_rgba(0,0,0,1)] flex flex-col gap-5">
        ...
        <Button type="submit" disabled={submitting} className="font-black uppercase tracking-widest border-2 border-foreground rounded-none shadow-[4px_4px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-[4px] hover:translate-y-[4px] transition-all bg-accent-green text-foreground hover:bg-accent-green">
