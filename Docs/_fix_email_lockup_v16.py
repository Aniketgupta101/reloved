...
NEW_IMG = (
    '<img src="https://reloved-digital.web.app/images/reloved-email-lockup.png?v=16" '
    'width="260" height="71" alt="RELOVED" '
    'style="display:block; border:0; width:260px; height:71px; max-width:100%;">'
)
IMG_TAG = re.compile(
...
for t in items:
    ...
    print(
        f"#{tid} {name}: updated v16={('v=16' in ch)} "
        f"260x71={('width=\"260\" height=\"71\"' in ch)}"
    )
