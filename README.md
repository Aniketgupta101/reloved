...
- [`Docs/PRIVACY_POLICY.md`](Docs/PRIVACY_POLICY.md) / [`Docs/TERMS_AND_CONDITIONS.md`](Docs/TERMS_AND_CONDITIONS.md) — legal page source (also live on-site at `/privacy` and `/terms`)
